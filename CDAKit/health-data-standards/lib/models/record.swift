...
//      }
  ...
  */
  ...
  override open var description : String {
    return "CDAKRecord => prefix: \(String(describing: prefix)), first: \(String(describing: first)), last: \(String(describing: last)), suffix: \(String(describing: suffix)), gender: \(String(describing: gender)), birthdate: \(String(describing: birthdate)), deathdate: \(String(describing: deathdate)), religious_affiliation: \(String(describing: religious_affiliation)), effective_time: \(String(describing: effective_time)), race: \(String(describing: race)), ethnicity: \(String(describing: ethnicity)), languages = \(String(describing: languages)), marital_status: \(String(describing: marital_status)), medical_record_number: \(String(describing: medical_record_number)), medical_record_assigner: \(String(describing: medical_record_assigner)), expired: \(String(describing: expired)), clinicalTrialParticipant: \(String(describing: clinicalTrialParticipant)), allergies: \(String(describing: allergies)), care_goals: \(String(describing: care_goals)), conditions: \(String(describing: conditions)), encounters: \(String(describing: encounters)), communications: \(String(describing: communications)), family_history: \(String(describing: family_history)), immunizations: \(String(describing: immunizations)), medical_equipment: \(String(describing: medical_equipment)), medications: \(String(describing: medications)), procedures: \(String(describing: procedures)), results: \(String(describing: results)), social_history: \(String(describing: social_history)), vital_signs: \(String(describing: vital_signs)), advance_directives: \(String(describing: advance_directives)), insurance_providers: \(String(describing: insurance_providers)), functional_statuses: \(String(describing: functional_statuses)), provider_performances: \(String(describing: provider_performances)), addresses: \(String(describing: addresses)), telecoms: \(String(describing: telecoms))"
  }
